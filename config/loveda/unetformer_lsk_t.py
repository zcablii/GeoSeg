...
weights_name = "unetformer-lsk_t-512crop-ms-epoch30-rep"
...
train_dataset = LoveDATrainDataset(transform=train_aug, data_root='/root/siton-gpfs-pubdata/remote_sense/LoveDA/trainval')
